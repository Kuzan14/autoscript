...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/Kuzan14/izinsc/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Kuzan14/autoscript/main/"
start=$(date +%s)
secs_to_human() {
...
wget -O /usr/bin/ws "https://raw.githubusercontent.com/Kuzan14/izinsc/main/ip"
wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/Kuzan14/izinsc/main/ip"
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/Kuzan14/izinsc/main/ip"
